...
class HrPayslip(models.Model):
    ...
    def _include_gosi(self):
        for line in self:
            ...
            day_upto = line.date_from + relativedelta(day=25)
            last_date = line.date_to + relativedelta(months=+1, day=1, days=-1)
            if line.date_to == last_date and line.date_from < day_upto:
    ...
    def onchange_employee_id(self, date_from, date_to, employee_id=False, contract_id=False):
        """
            onchange gosi based on selecting employee_id.
        """
